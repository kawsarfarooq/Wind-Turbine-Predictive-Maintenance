...
### WP3 — Residual and detector ablations: next

- Add a nonlinear normal-behaviour model.
- Compare smoothing windows and threshold quantiles.
- Produce fault-type and asset-level interpretations.
- Retain the two strongest configurations for downstream experiments.

### WP4 — Missingness-to-detection study: pending

- Inject random, block, and sensor-dropout missingness.
- Compare forward fill, linear, median, and Gaussian-process imputation.
- Measure imputation RMSE, event discrimination, detection, and false alarms.

### WP5 — Cost-aware controlled study: pending
